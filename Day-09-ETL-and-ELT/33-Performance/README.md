...
Pipeline performance depends on source extraction, network transfer, compute, storage and destination writes.
...
Optimize measured bottlenecks rather than making random configuration changes.
...
Throughput is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Latency

Latency is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### CPU

CPU is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Memory

Memory is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### I/O

I/O is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Shuffle

Shuffle is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
```text
Measure -> Find Bottleneck -> Optimize -> Benchmark
```
...
Automobile example: replace a full telemetry scan with date-partition pruning and incremental processing.
...
Track rows per second, bytes processed, task duration and cost to compare improvements objectively.
