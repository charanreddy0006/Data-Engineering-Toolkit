...
Airflow is commonly used to orchestrate ETL workflows through directed acyclic graphs.
...
Tasks can execute Python, SQL, Spark jobs or cloud services while Airflow tracks dependencies and state.
...
DAG is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Operator

Operator is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Task

Task is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Schedule

Schedule is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### XCom

XCom is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
```text
Airflow DAG -> Extract -> Transform -> Load -> Tests
```
...
Automobile example: schedule a daily service-data pipeline and alert the team when the warehouse load fails.
...
Airflow should orchestrate processing rather than becoming the processing engine itself.
