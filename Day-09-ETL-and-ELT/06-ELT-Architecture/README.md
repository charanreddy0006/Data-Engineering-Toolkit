...
ELT loads extracted data into a scalable destination before applying analytical transformations.
...
ELT is especially effective when the warehouse, lakehouse or SQL engine can scale compute independently from storage.
...
Landing zone is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Raw tables

Raw tables is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Staging models

Staging models is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Intermediate models

Intermediate models is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Data marts

Data marts is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Tests

Tests is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
```text
Source -> Ingestion -> Raw Tables -> SQL/dbt -> Curated Models -> BI
```
...
Automobile example: raw telemetry is retained in cloud storage or a lakehouse and multiple downstream models calculate battery, driving and maintenance metrics.
...
ELT makes raw data reusable, but access controls and data retention policies become especially important.
