# Why ETL and ELT Exist

## 1. Introduction

Operational applications are designed to run business transactions. Analytics requires combining data from many systems, applying consistent definitions and processing large historical volumes.
...
A pipeline creates a repeatable path between producers and consumers. It also provides validation, logging, monitoring and recovery mechanisms.
...
Data silos is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Different schemas

Different schemas is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Different formats

Different formats is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Business transformations

Business transformations is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Historical analytics

Historical analytics is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Data quality

Data quality is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
```text
Many Sources -> Integration Layer -> Trusted Data -> BI / ML
```
...
Automobile example: sales data alone cannot explain vehicle reliability. Service, warranty and telemetry data must be combined.
...
The engineering goal is not simply copying data. It is creating trustworthy and reusable data products.
