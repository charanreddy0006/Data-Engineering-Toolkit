...
ETL pipelines frequently transport sensitive business and customer data, so security must be designed into every stage.
...
Use encryption, least privilege, secret management, network controls and auditing.
...
Authentication is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Authorization

Authorization is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Encryption

Encryption is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Secrets

Secrets is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Least privilege

Least privilege is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Audit

Audit is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
```text
Secure Source -> Secure Pipeline -> Secure Storage -> Controlled Access
```
...
Automobile example: restrict access to customer-linked vehicle data while allowing analysts to use anonymized aggregates.
...
Never commit passwords, API keys or database credentials into source code or Git.
