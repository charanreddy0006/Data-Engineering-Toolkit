...
Data lakes store large volumes of raw and processed data, often using object storage.
...
ETL can create raw, cleaned and curated layers while preserving source data for replay.
...
Raw zone is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Bronze

Bronze is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Silver

Silver is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Gold

Gold is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
Parquet is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
Automobile example: raw vehicle events are preserved in bronze while validated telemetry becomes silver and fleet KPIs become gold.
...
File formats, partitioning, schema evolution and small-file management are important lake concerns.
