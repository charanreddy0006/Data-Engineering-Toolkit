...
A production ETL architecture separates extraction, staging, transformation and loading so each responsibility can be tested and operated independently.
...
Raw or staging data provides a recovery point. Transformation logic should be deterministic and the final load should be controlled by quality checks.
...
Sources is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Extractors

Extractors is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
Transformation is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Quality gates

Quality gates is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Target systems

Target systems is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Monitoring

Monitoring is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
```text
Source -> Extract -> Staging -> Validate -> Transform -> Quality Gate -> Target
```
...
Automobile example: service database -> staging -> cleaned service records -> warehouse fact table.
...
Good architecture isolates failures and makes it possible to replay source data without repeatedly hitting operational systems.
