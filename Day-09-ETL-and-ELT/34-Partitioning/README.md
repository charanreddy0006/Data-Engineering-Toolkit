...
Partitioning divides large datasets into manageable subsets based on a key.
...
Good partitioning reduces the amount of data scanned for common query patterns.
...
Date partition is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Hash partition

Hash partition is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Range partition

Range partition is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Partition pruning

Partition pruning is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Skew

Skew is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
```text
Dataset -> Partition Key -> Smaller Data Sets
```
...
Automobile example: partition telemetry by event date and optionally organize files by vehicle region.
...
Do not partition on extremely high-cardinality values such as unique event IDs.
