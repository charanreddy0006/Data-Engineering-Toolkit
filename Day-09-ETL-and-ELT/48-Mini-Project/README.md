# Mini Project: Vehicle Service ETL

## 1. Introduction

Build a small ETL pipeline that reads service records, validates them, cleans values, removes duplicates and creates vehicle-level summaries.
...
The project is intentionally small enough to run locally while demonstrating production-oriented concepts.
...
CSV input is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Validation

Validation is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Cleansing

Cleansing is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Deduplication

Deduplication is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Aggregation

Aggregation is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Output

Output is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
```text
CSV -> Python -> Raw Check -> Clean -> Deduplicate -> Summary
```
...
Automobile example: calculate service count, total cost and latest service date per vehicle.
...
Extend the project later with PostgreSQL, Airflow, Docker and automated quality tests.
