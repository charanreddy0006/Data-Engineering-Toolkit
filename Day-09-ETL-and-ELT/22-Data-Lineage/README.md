...
Data lineage records the path from source data to downstream datasets and reports.
...
Lineage supports impact analysis, debugging, governance and auditability.
...
Source lineage is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Column lineage

Column lineage is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Transformation lineage

Transformation lineage is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Impact analysis

Impact analysis is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Traceability

Traceability is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
```text
Source Field -> Transformation -> Curated Field -> Dashboard
```
...
Automobile example: trace a battery-health KPI back through the curated model to the original sensor field.
...
Lineage becomes increasingly important as the number of pipelines and consumers grows.
