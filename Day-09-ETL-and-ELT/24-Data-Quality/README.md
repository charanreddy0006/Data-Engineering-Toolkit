...
Accuracy is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Completeness

Completeness is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Consistency

Consistency is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Validity

Validity is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Uniqueness

Uniqueness is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Timeliness

Timeliness is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
```text
Pipeline -> Quality Tests -> Score / Gate -> Publish
```
...
Automobile example: monitor telemetry completeness by comparing expected and received event counts.
...
Quality thresholds should be agreed with data consumers because not every dataset needs the same tolerance.
