...
Standardization makes data from different sources comparable by applying common types, units, naming conventions and formats.
...
Without standardization, two systems may represent the same concept differently.
...
Units is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Dates

Dates is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Time zones

Time zones is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Names

Names is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Codes

Codes is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Data types

Data types is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
```text
Source A + Source B -> Canonical Schema
```
...
Automobile example: convert miles per hour to kilometers per hour before combining vehicle datasets.
...
Define canonical values centrally rather than creating different conversions in every downstream report.
