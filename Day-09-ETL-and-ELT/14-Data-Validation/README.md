...
Validation determines whether incoming records satisfy structural and business rules.
...
Validation should happen before data is promoted to trusted layers. Failed records should be measurable and recoverable.
...
Schema checks is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Null checks

Null checks is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Range checks

Range checks is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Referential checks

Referential checks is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
```text
Input -> Schema Check -> Business Rules -> Valid / Quarantine
```
...
Automobile example: battery percentage must be between 0 and 100 and service cost cannot be negative.
...
Validation rules should be explicit, version-controlled and visible in pipeline monitoring.
