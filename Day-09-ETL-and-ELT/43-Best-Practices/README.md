...
Production ETL should be modular, observable, secure, testable and restartable.
...
Treat data pipelines as software products with source control, reviews, automated tests and documented ownership.
...
Idempotency is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Incremental loads

Incremental loads is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
Logging is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Secrets management

Secrets management is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Documentation

Documentation is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
```text
Reliable Source -> Reliable Pipeline -> Trusted Data
```
...
Automobile example: every hourly vehicle-health pipeline run records input count, output count, rejected count and duration.
...
Build operational safety into the design rather than adding it after the first failure.
