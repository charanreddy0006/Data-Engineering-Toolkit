...
Cleansing improves the consistency and usability of source data without losing the original raw representation.
...
Common operations include trimming text, correcting data types, handling missing values and standardizing obvious formatting problems.
...
Missing values is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Whitespace

Whitespace is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Invalid types

Invalid types is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Case normalization

Case normalization is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Outliers

Outliers is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
```text
Raw Data -> Cleansing Rules -> Clean Data
```
...
Automobile example: convert ` toyota ` and `TOYOTA` into a standard manufacturer value.
...
Do not silently invent values. Distinguish unknown, missing, not-applicable and invalid states where the business requires it.
