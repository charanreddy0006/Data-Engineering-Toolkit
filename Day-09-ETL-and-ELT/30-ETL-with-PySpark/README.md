...
PySpark provides Python APIs for distributed Spark processing.
...
Spark is useful when datasets are too large or transformations are too computationally expensive for a single machine.
...
DataFrame is an important part of this concept. Understand its responsibility,
...
Action is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Partition

Partition is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
Cache is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
```text
Object Storage -> Spark -> Distributed Transform -> Parquet
```
...
Automobile example: aggregate billions of telemetry events by vehicle and day.
...
Performance depends on partitioning, shuffles, file sizes, joins and cluster configuration.
