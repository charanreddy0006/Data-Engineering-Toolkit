...
dbt organizes SQL transformations into modular models with tests, documentation and dependency management.
...
dbt is well suited to the transformation layer after data has landed in a warehouse or compatible platform.
...
Models is an important part of this concept. Understand its responsibility,
...
Macros is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Seeds

Seeds is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Snapshots

Snapshots is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
```text
Raw Tables -> dbt Models -> Staging -> Intermediate -> Marts
```
...
Automobile example: build vehicle, service and warranty marts from raw warehouse tables.
...
Use model naming, tests, documentation and incremental strategies consistently across a project.
