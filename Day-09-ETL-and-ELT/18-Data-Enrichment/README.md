...
Enrichment adds useful context from reference data or external sources.
...
Enrichment commonly uses joins with master-data tables, geospatial data, customer attributes or product catalogs.
...
Reference data is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Master data

Master data is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Lookup

Lookup is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
Derived attributes is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
```text
Telemetry + Vehicle Master + Region -> Enriched Dataset
```
...
Automobile example: attach vehicle model, manufacturing year and region to raw telemetry events.
...
Validate join cardinality. A one-to-many mistake can accidentally multiply analytical rows.
