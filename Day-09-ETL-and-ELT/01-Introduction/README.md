...
ETL and ELT are patterns for moving data from operational sources into systems where it can be analyzed, reported, or used by machine-learning applications.
...
ETL means Extract, Transform, Load. ELT means Extract, Load, Transform. Both solve the same broad integration problem but place transformation at different stages.
...
Data integration is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Source systems

Source systems is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Analytical systems

Analytical systems is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Pipelines

Pipelines is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Batch and streaming workloads

Batch and streaming workloads is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
```text
Source -> Extract -> Raw/Staging -> Validate -> Transform -> Load -> Analytics
```
...
Automobile example: vehicle telemetry, dealer systems, service records and warranty records are integrated into a common analytical platform.
...
Start with one CSV, then move to databases, APIs, cloud storage and finally distributed processing.
