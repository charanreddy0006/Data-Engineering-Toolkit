...
ETL cost includes compute, storage, data transfer and operational overhead.
...
Incremental processing, compression, partition pruning and right-sized compute can significantly reduce cost.
...
Compute is an important part of this concept. Understand its responsibility,
...
Transfer is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Compression

Compression is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Incremental processing

Incremental processing is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Scheduling

Scheduling is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
```text
Measure Spend -> Find Waste -> Optimize -> Verify
```
...
Automobile example: avoid repeatedly scanning years of telemetry when only the latest partition changed.
...
Cost optimization should never remove validation or reliability controls merely to save compute.
