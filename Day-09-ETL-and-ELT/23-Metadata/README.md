...
Metadata describes datasets, columns, ownership, schema, location, freshness and operational properties.
...
Metadata helps users discover data and helps engineers operate pipelines safely.
...
Technical metadata is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Business metadata

Business metadata is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Operational metadata

Operational metadata is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
```text
Dataset -> Metadata -> Catalog -> Consumers
```
...
Automobile example: document the unit, range, owner and refresh interval of battery percentage.
...
Metadata should be updated as part of the pipeline lifecycle instead of being maintained manually once.
