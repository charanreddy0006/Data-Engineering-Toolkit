...
Extraction is the process of reading records from source systems without disrupting their primary workload.
...
Extraction can use database queries, APIs, files, message queues or change-data-capture mechanisms. The strategy should match the source's capabilities and operational limits.
...
Full extraction is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Incremental extraction

Incremental extraction is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### API extraction

API extraction is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### File extraction

File extraction is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Database extraction

Database extraction is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### CDC

CDC is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
```text
Source -> Connector -> Extracted Dataset -> Raw Storage
```
...
Automobile example: pull newly updated service records using an `updated_at` timestamp.
...
Important extraction concerns include authentication, rate limits, schema changes, pagination, time zones and source-system load.
