...
Change Data Capture records inserts, updates and deletes occurring in source databases.
...
CDC can use database logs, triggers or specialized connectors. Log-based CDC generally reduces the need for repeated full-table scans.
...
Insert is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Update

Update is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Delete

Delete is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Transaction log

Transaction log is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Offset

Offset is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Ordering

Ordering is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
```text
OLTP Database -> CDC -> Event Stream -> Raw Layer -> Curated Layer
```
...
Automobile example: a service-status update can be captured and propagated to analytics without waiting for a nightly batch.
...
CDC requires careful handling of ordering, deletes, schema changes, duplicates and replay.
