...
Transformation changes raw records into consistent analytical data.
...
Typical transformations include filtering, type conversion, joins, calculations, normalization, aggregation, deduplication and enrichment.
...
Filtering is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Type conversion

Type conversion is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Joins

Joins is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
Normalization is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Business rules

Business rules is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
```text
Raw -> Clean -> Standardized -> Enriched -> Curated
```
...
Automobile example: convert speed units, normalize vehicle models, join vehicle metadata and calculate average speed.
...
Transformations should be modular and tested. Avoid hiding complex business logic inside one enormous script.
