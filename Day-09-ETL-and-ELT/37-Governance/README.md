...
Governance defines ownership, access, definitions, retention, quality and acceptable use of data.
...
Governance turns a collection of technical pipelines into a controlled data ecosystem.
...
Ownership is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Policies

Policies is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Data contracts

Data contracts is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Retention

Retention is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Classification

Classification is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.

### Stewardship

Stewardship is an important part of this concept. Understand its responsibility,
inputs, outputs and failure conditions before implementing it in a production
pipeline.
...
```text
Data Product -> Owner -> Policy -> Consumers
```
...
Automobile example: define the owner and retention period for vehicle-location datasets.
...
Governance should enable useful data access while preventing uncontrolled exposure or ambiguity.
