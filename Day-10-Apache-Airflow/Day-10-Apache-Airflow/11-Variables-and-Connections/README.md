...
Variables store configurable values and Connections represent external-system connection information.
...
They prevent environment settings and credentials from being hard-coded in DAG source.
