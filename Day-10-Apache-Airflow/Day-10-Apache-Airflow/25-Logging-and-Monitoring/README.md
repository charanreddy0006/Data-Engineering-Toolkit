...
Airflow provides task logs and workflow state and can be integrated with monitoring systems.
...
Production monitoring must cover both task execution and data quality.
