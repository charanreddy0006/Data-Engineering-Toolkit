...
Sensors wait for external conditions such as files, database states, datasets or other workflows.
...
They are useful when processing should begin only after an external dependency is ready.
