...
Scaling means increasing workflow capacity while maintaining reliability and operational control.
...
Schedulers, workers, executors, pools and metadata databases all influence scale.
