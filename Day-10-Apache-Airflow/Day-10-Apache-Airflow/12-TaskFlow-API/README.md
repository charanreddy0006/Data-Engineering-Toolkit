...
TaskFlow uses decorators such as @task to create Python tasks and infer dependencies from function calls.
...
It reduces boilerplate and makes small Python workflows easier to read.
