...
Production deployments require durable metadata, secure execution, observability and controlled releases.
...
The design must tolerate worker, database, network and external-service failures.
