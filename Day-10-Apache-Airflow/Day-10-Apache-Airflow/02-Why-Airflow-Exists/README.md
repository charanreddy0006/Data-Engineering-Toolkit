...
Airflow exists to solve workflow scheduling and dependency-management problems that become difficult with independent scripts and cron jobs.
...
As a pipeline grows, operators need to know what ran, what failed, what should run next, how to rerun historical data and where the failure occurred.
