...
A task represents a unit of work. Operators provide reusable ways to define common kinds of tasks.
...
Good task boundaries improve retries, logging, observability and debugging.
