...
Airflow supports Jinja templates and runtime context values for dynamic task arguments.
...
Templates are useful for dates, partitions, SQL parameters and paths.
