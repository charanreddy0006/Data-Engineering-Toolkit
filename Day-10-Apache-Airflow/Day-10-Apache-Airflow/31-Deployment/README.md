...
Deployment includes configuration, database migrations, security, backups, releases and rollback procedures.
...
Production environments should be reproducible rather than manually edited.
