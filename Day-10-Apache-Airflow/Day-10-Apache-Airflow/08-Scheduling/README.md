...
Scheduling determines when Airflow creates workflow runs based on schedules, data intervals and timetables.
...
Scheduling should match the availability and freshness requirements of the source data.
