...
Airflow is an open-source workflow orchestration platform. It lets engineers author workflows as Python code, schedule them, execute tasks, inspect history and respond to failures.
...
Modern data platforms contain dependent jobs. Airflow gives those jobs a visible DAG, scheduling model, task state, retries and operational interface.
