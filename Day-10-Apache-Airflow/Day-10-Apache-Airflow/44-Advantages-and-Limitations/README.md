...
Airflow provides workflow-as-code, dependency management, scheduling, monitoring and a broad ecosystem.
...
It is not a replacement for distributed processing engines, event brokers or analytical databases.
