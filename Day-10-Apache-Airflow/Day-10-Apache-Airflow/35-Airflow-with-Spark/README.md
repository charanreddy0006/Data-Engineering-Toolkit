# Airflow with Apache Spark

## 1. Introduction

Airflow can submit and monitor Spark processing jobs.
...
Spark performs distributed computation while Airflow controls when it runs and what follows it.
