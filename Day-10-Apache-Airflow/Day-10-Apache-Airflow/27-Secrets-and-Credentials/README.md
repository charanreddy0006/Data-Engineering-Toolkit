...
Secrets include passwords, API keys and tokens that must be protected.
...
Use managed connections or secrets backends rather than committing credentials to Git.
