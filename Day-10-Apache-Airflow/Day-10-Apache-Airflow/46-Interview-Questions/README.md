...
Airflow interviews cover DAGs, scheduling, dependencies, retries, architecture, security and scaling.
...
Strong answers explain both normal execution and failure behavior.
