...
A DAG is a directed graph of tasks with dependencies and no cycles.
...
DAGs make workflow order explicit and allow Airflow to reason about which tasks are eligible to run.
