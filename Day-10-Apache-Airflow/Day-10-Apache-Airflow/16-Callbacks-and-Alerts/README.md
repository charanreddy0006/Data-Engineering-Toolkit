...
Callbacks execute logic when task or DAG events occur, such as failures or successes.
...
Operational alerts should provide enough context for an engineer to investigate quickly.
