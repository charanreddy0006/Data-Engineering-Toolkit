...
The metadata database stores orchestration state such as DAG runs, task instances and configuration.
...
It is a control-plane database, not a destination for large business datasets.
