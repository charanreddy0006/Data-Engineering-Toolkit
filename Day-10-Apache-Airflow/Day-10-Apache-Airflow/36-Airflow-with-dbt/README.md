...
Airflow can run dbt transformations and tests as part of a larger workflow.
...
dbt handles SQL transformation while Airflow handles cross-system orchestration.
