...
Core Airflow components include DAGs, DAG processors, schedulers, executors, workers, the metadata database, the UI/API and the triggerer.
...
Each component has a specific responsibility. Understanding the boundary prevents architectural misuse.
