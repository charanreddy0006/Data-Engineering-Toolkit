...
Datasets let workflows express dependencies based on data availability.
...
A consumer can react to a producer's dataset update instead of relying only on a clock.
