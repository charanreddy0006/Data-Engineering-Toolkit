...
Airflow can coordinate extraction, validation, transformation and loading workflows.
...
The orchestration layer should coordinate ETL rather than become the ETL engine itself.
