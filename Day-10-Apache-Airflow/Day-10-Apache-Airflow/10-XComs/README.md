...
XComs provide lightweight communication between tasks.
...
They are appropriate for small values such as file paths, IDs, counts and statuses, not large datasets.
