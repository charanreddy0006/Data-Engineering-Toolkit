...
Airflow supports retry policies for failed task instances.
...
Transient infrastructure failures can often be retried while permanent data errors should be handled explicitly.
