# Airflow Compared with Alternatives

## 1. Introduction

Airflow is one orchestration choice among Airflow, Prefect, Dagster, cron and cloud-native tools.
...
Selection should consider workload, ecosystem, operations, team skills and required scheduling model.
