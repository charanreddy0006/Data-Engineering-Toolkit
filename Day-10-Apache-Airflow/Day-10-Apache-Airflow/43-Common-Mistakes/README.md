...
Common problems include oversized XComs, hard-coded credentials, non-idempotent loads and excessive task fragmentation.
...
Understanding anti-patterns prevents unreliable production workflows.
