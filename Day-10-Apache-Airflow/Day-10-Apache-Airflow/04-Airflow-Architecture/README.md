...
Airflow separates workflow parsing, scheduling, task execution, metadata storage and user interaction.
...
This separation allows orchestration components to scale independently from the systems that process data.
